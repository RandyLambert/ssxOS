- # 引言
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20210127152028111.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzU3NDk2Mg==,size_16,color_FFFFFF,t_70)
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20210127151932659.png)
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20210127151912283.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzU3NDk2Mg==,size_16,color_FFFFFF,t_70)
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20210127152134256.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzU3NDk2Mg==,size_16,color_FFFFFF,t_70)
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20210127154059670.png)
  ...
  ![](https://img-blog.csdnimg.cn/img_convert/e9783640178d86f4e5c73f6b2157faec.png)
  ...
  ![](https://img-blog.csdnimg.cn/img_convert/8c18bf118f445d3a917c2bafe0a1843f.png)

  ELF的布局在链接阶段和运行阶段并不太一样,主要是因为节最终会合并成段,ELF 格式的文件头包含了**程序头表**（program header table）和**节头表**（section header table）和 **ELF 表**.

  ![](https://img-blog.csdnimg.cn/img_convert/1ab37075e9be11e40c6923bd2ee4c18b.png)
